...
export const LAB_CATEGORIES: LabCategory[] = [
  {
    name: t('Products & Tools'),
    entries: [
      {
        title: t('Metro Metaphor: A Visual Identity That Reached the Data Structures'),
        type: 'Experiment',
        status: 'Live',
        summary: t(
      ...
      {
        title: t('Departure Board UX: BVG-Styled Scroll-Linked Navigation'),
        type: 'Product',
        status: 'Live',
        summary: t(
      ...
      {
        title: t('Three Portfolio Patterns I Prototyped and Dropped'),
        type: 'Experiment',
        status: 'Archived',
        summary: t(
  ...
  {
    name: t('Systems & Workflows'),
    entries: [
      {
        title: t('Employment Panopticon: AI-Powered Job Hunt Command Center'),
        type: 'Product',
        status: 'In Progress',
        summary: t(
      ...
      {
        title: t('Panopticon: Persistent AI Context System'),
        type: 'Workflow',
        status: 'Live',
        summary: t(
      ...
      {
        title: t('Panopticon Assistant: WhatsApp AI Agent'),
        type: 'Product',
        status: 'Live',
        summary: t(
      ...
      {
        title: t('Cowork as Design Collaborator: A Two-Claude Workflow'),
        type: 'Workflow',
        status: 'Live',
        summary: t(
      ...
      {
        title: t('Anonymizing a Client Case Study Without Losing the Substance'),
        type: 'Workflow',
        status: 'Live',
        summary: t(
      ...
      {
        title: t('Playable Case Studies: Live Demo Embeds'),
        type: 'Workflow',
        status: 'Live',
        summary: t(
  ...
  {
    name: t('Research & Evaluation'),
    entries: [
      {
        title: t('Scoring My Old Portfolio: Building a Rubric, Then Designing From the Diagnosis'),
        type: 'Evaluation',
        status: 'Live',
        summary: t(
      ...
      {
        title: t('Gemini to Claude: Evaluating AI Provider Quality'),
        type: 'Evaluation',
        status: 'Learning',
        summary: t(
